                  ...
                  <div className="flex gap-6">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="text-xs text-gray-500 flex flex-col gap-1">
                        <p>
                          Before pledge:{" "}
                          {verdict.avg_loss_before_ha.toLocaleString()} ha
                          lost/yr
                        </p>
                        <p>
                          After pledge:{" "}
                          {verdict.avg_loss_after_ha.toLocaleString()} ha
                          lost/yr
                        </p>
                        <p>
                          Forest saved: {verdict.reduction_ha.toLocaleString()}{" "}
                          ha/yr
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3 justify-center">
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-sm font-medium">
                          {claim?.hectares != null
                            ? Number(claim.hectares).toLocaleString()
                            : "—"}{" "}
                          ha
                        </p>
                      </div>
                      <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-sm font-medium">
                          {claim?.year_start ?? "—"} – {claim?.year_end ?? "—"}
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="border border-gray-300 rounded-md p-2 overflow-hidden">
            {claim?.coords ? (
              <SatelliteComparison
                ...
                location={claim.primary_location || claim.location}
